...
INTO BRANCH VALUES ('DHAMTARI ROAD','BILASPUR')
...
FROM 
  ...
  INNER JOIN BORROW  ON CUSTOMER.CNAME = DEPOSIT.CNAME
...
SELECT CNAME,DEPOSIT.AMOUNT AS DEPOSITE_AMOUNT ,BORROW.AMOUNT AS BORROW_AMOUNT 
